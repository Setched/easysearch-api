 ...
 * {@code ozon-scraper} service (see {@code ozon-scraper/README.md}), which scrapes Ozon's public search
 * page and returns results in the same shape this class used to expect from a real API.
 */
