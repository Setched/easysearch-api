...
class SearchControllerTest {
    ...
    /**
     * Verifies that a request to a path with no matching route (e.g. a browser visiting {@code /} on
     * this API-only service) returns a plain 404, not the catch-all 500.
     */
    @Test
